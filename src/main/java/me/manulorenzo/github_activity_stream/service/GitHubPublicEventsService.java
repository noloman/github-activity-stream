...
public class GitHubPublicEventsService {
    ...
    public GitHubPublicEventsService(KafkaTemplate<String, String> kafkaTemplate,
    ...
    public void fetchPublicEvents() {
        ...
        try {
            ResponseEntity<GitHubEvent[]> response = restTemplate.getForEntity(
                    gitHubPublicEventsProperties.getApiUrl(),
                    GitHubEvent[].class
            );
            ...
            log.error("Error fetching public events from {}", gitHubPublicEventsProperties.getApiUrl(), e);
        }
    }
